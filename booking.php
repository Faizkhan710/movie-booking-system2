            ...
            <div class="booking-form-container">
                <form action="verify.php" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="12-3">December 12,2022</option>
                        <option value="13-3">December 13,2022</option>
                        <option value="14-3">December 14,2022</option>
                        <option value="15-3">December 15,2022</option>
                        <option value="16-3">December 16,2022</option>
                    </select>
